...
_this.props.onMarkerPress(selectedMarker);
}
}
return thumbTouched;
},_this.
...
pointerEvents:"none",__source:{fileName:_jsxFileName,lineNumber:611}}));
...
pointerEvents:"none",__source:{fileName:_jsxFileName,lineNumber:631}}));
...
return _react2.default.createElement(_reactNative.Image,{source:thumbImage,__source:{fileName:_jsxFileName,lineNumber:648}});
},_this.
...
for(var i=0;i<numOfMarkers;i++){
markers.push(
_react2.default.createElement(_reactNative.View,{key:i,style:outerStyle,__source:{fileName:_jsxFileName,lineNumber:668}},
_react2.default.createElement(_reactNative.View,{style:[defaultStyles.markerStyle,markerStyle],__source:{fileName:_jsxFileName,lineNumber:669}})));
...
return(
_react2.default.createElement(_reactNative.View,{style:containerStyle,renderToHardwareTextureAndroid:true,__source:{fileName:_jsxFileName,lineNumber:681}},
markers));
